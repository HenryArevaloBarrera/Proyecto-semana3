...
export default function PostCard({ post, deleting, onDelete }: PostCardProps) {
    ...
    return (
        <div className={`bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-5 transition hover:border-white/15
                        ...
                        <div className="mt-3 space-y-2">
                            ...
                            {likes.map((like) => {
                                ...
                                return (
                                    ...
                                    <div key={like.uid} className="flex items-center gap-2">
